...
class SendOTP {
    ...
    public function callGenerateAPI($request) {
        $data = array("mobileNumber" => $_POST['mob'],"getGeneratedOTP" => true);
        ...
        curl_setopt($ch, CURLOPT_HTTPHEADER, array(
            ...
            'application-Key: 155668A1GN5ppGp712593aac29'
        ));
        $result = curl_exec($ch);
        curl_close($ch);
        return $result;
    ...
    {
        $data = array( "mobileNumber" => $_POST['mob'], "oneTimePassword" => $request['oneTimePassword']);
        $data_string = json_encode($data);
